...
use Exception;
use BelSmol\ShipPayExport\Api\ShippingMethodListExportInterface as ExportModel;
...
/**
 * Class ExportShippingMethodList
 * @package BelSmol\ShipPayExport\Console\Command
 */
class ExportShippingMethodList extends Command
{
    protected const COMMAND_NAME = "belsmol:export:export-shipping-method-list";
    ...
    protected function configure(): void
    {
        ...
        $this->setDescription("Export list of current magento shipping methods");

        parent::configure();
    }

    /**
     * Export all shipping methods from Magento
     *
